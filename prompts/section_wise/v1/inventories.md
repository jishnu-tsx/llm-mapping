...
Inputs:
1. balance_sheet.png : the main balansheet that contains the parent fields and values 
2. notes :(optional) : a image of notes containing the data of financial assets for a balance sheet 
...
map the fields in balance_sheet.png to the given variables , for breakdown data of a field check notes 
